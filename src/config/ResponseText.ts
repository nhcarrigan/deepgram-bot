...
export enum ResponseText {
  ...
  MovedThread = "Please make sure to respond in this thread with as much detail about your question as possible. This will help us better provide you support. Such as:\n- `request_id` if you've a question about a transcription response.\n- The options you used or the api.deepgram.com URL to send your request to, including parameters.\n- Any code snippets you can include.\n- Any audio you can include, of if you can't share it here please email it to us at devrel@deepgram.com and provide a link to this thread.",
